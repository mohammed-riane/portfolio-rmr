                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                        {experiences.map((exp, index) => (
                            ...
                            >
                                <div
                                    className="absolute -left-2 top-0 w-4 h-4 bg-experience rounded-full shadow-lg"></div>

                                <div
                                    className="bg-card border border-border rounded-xl p-6 card-shadow hover:glow smooth-transition">
                                    <div
                                            ...
                                            <div className="flex flex-col items-end gap-2">
                                                {exp.roles.map((role, roleIndex) => (
                                                    <div key={roleIndex} className="flex flex-col items-end gap-1">
                                                        ...
                                                        <span
                                                            className="px-3 py-1 bg-experience/10 text-experience text-xs rounded-full">
                              {role.type}
                            </span>
                                                    </div>
                                                ))}
                    ...
                    <div className="mt-12 text-center">
                        <div
                            className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 text-primary rounded-full">
                            <Briefcase size={20}/>
