            ...
            <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                ...
                                I'm passionate about problem-solving, learning new technologies, and turning ideas into
                                practical solutions.
                            </p>
                            <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <span className="px-4 py-2 bg-primary/10 text-primary rounded-full text-sm font-medium">
                  Software Engineering
                                ...
                                <span
                                    className="px-4 py-2 bg-tech-stack/10 text-tech-stack rounded-full text-sm font-medium">
                  Full Stack Development
                </span>
                                <span
                                    className="px-4 py-2 bg-experience/10 text-experience rounded-full text-sm font-medium">
                  ...
                  E-Commerce Solutions
                        ...
                        <div className="grid gap-6">
                            <div
                                className="p-6 border border-border rounded-lg card-shadow hover:glow smooth-transition">
                                ...
                                <p className="text-muted-foreground">
                                    Writing maintainable, scalable, and well-documented code that stands the test of
                                    time.
                                </p>
                            </div>
