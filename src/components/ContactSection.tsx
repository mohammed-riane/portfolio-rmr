                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:riane.mohammed.reda@gmail.com"
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+212624454149"
                                           className="text-muted-foreground hover:text-tech-stack smooth-transition">
                                            +212 624-454149
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-6">
                            <div className="p-8 border border-border rounded-xl card-shadow bg-card">
                                ...
                                <ContactForm />
                                {/*<form action="https://formspree.io/f/xgvlgbwd" method="POST" className="space-y-4">*/}
                                {/*    <div>*/}
